...
def _call_claude(messages, data_context, web_search=False):
    ...
    system_prompt = (
        ...
        "FORMATTING RULES:\n"
        "- Always use full dollar amounts with commas (e.g. $1,280,000 not $1.28M)\n"
        "- Use markdown formatting: **bold** for emphasis, bullet points for lists\n"
        "- Put a blank line between paragraphs\n"
        "- When comparing projects, use a markdown table\n"
        "- Keep responses concise and direct -- no fluff\n"
        "- Use line breaks between different data points, never run them together\n\n"
